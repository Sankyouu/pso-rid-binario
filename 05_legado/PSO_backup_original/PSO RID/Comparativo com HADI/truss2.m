...
% TRELIÇA DE 10 BARRAS — Unidades conforme Hadi & Alvani (2003), Seção 6.1
% Unidades do sistema:
%   Comprimento : mm
%   Força       : N
%   Tensão      : MPa (= N/mm²)
...
E    = 6.89e4;      % Módulo de elasticidade [MPa = N/mm²]
dens = 2.770e-6;    % Densidade [kg/mm³]  (2770 kg/m³ convertido: 2770/1e9)
